...
kappa_eval = 3.0;
w_eval = w_crit;
lambda_eval = lambda_c; % 0.237129748135524;
mu0 = 1;
nu = 0.33;
L = 1;
...
eigenVect = [-systemMat_refed(1:3, 4); 1]';
amplitudes_v2 = (B').*eigenVect;
eigenVect = eigenVect/(sum(amplitudes_v2'.*exp(alphas)))
amplitudes_v2 = amplitudes_v2/(sum(amplitudes_v2'.*exp(alphas)))
