...
syms kappa x1 x2 nu l1 l2 A1 A2 a1 a2 w B1 B2;

syms A1 A1B1 A2 A2B2 a1 a2;

u1 = -(A1*cosh(a1*w*x2) + A2*cosh(a2*w*x2))*sin(w*x1);
u2 = (A1*B1*sinh(a1*w*x2) + A2*B2*sinh(a2*w*x2))*cos(w*x1);
...
syms M111111 M222222 M111122 M112222 M111212 M112121 ...
 ...
 rhs_1 = -( diff(term_1_1, x1) + diff(term_1_2, x2));
 ...
 rhs_2 = -(diff(term_2_1, x1) + diff(term_2_2, x2));
